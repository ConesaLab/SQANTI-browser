...
- If `highlight` section is omitted, highlight colors are auto-generated by darkening standard colors (if no interest in highlighting isoforms, include the `--no-highlight` flag)
